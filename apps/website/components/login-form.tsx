...
export function LoginForm({
  ...
  const selectedImage = useMemo(() => {
    ...
    return carouselImages[Math.abs(hash) % carouselImages.length];
  }, [pathname]);
        ...
        <div className="flex items-center justify-center p-8" style={{ backgroundColor: "#0b0b0b" }}>
          <div className="w-full max-w-sm space-y-7">
            ...
            >
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="email" style={{ color: "#9a7060", fontSize: "13px" }}>
                    Email
                  </Label>
                  <Input
                    id="email"
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="password" style={{ color: "#9a7060", fontSize: "13px" }}>
                      Password
                    </Label>
                    <Link
            ...
            <p className="text-center text-sm" style={{ color: "#4a3020" }}>
              Chưa có tài khoản?{" "}
              <Link href="/auth/sign-up" className="transition-colors hover:underline" style={{ color: "#FF6B35" }}>
                Đăng ký
              </Link>
            </p>
          </div>
